...
import { IEvent, ISession } from './event.modal';
...
export class EventService {
  ...
  searchSessions(searchTerm: string) {
    ...
    const emitter = new EventEmitter(true); // passing true tells the emiter to deliver its events asynchronously
    setTimeout(() => {
